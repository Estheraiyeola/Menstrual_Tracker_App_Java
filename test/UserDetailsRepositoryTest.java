...
public class UserDetailsRepositoryTest {
    ...
    @Test
    public void testThatA_User_Can_BeFound_With_Their_First_Name(){
        UserDetails details = new UserDetails();
        details.setFirstName("Esther");
        details.setLastName("Aiyeola");
        userDetailsRepository.save(details);
        ...
        assertEquals(details1.getUsername() ,userDetailsRepository.findByUsername("Deborah Madison").getUsername());
    }
}
